<?php
$_GET['site']=$_REQUEST['site']=$_SESSION['site_id']=$argv[1];
$_POST['pdf']=$_REQUEST['pdf']=$argv[2];
$_POST['pdf_type']=$_REQUEST['pdf_type']=$argv[3];
$_POST['patient']=$_REQUEST['patient']=$argv[4];
$_POST['starting_patient']=$_REQUEST['starting_patient']=$argv[4];
$_POST['ending_patient']=$_REQUEST['ending_patient']=$argv[5];
$_POST['email']=$_REQUEST['email']=$argv[6];
$ignoreAuth=true;
  ...
  if (substr($formdir,0,3) == 'LBF')
	...
	//documents
		...
		$b[]=$a[$i];
		    ...
		    echo "<img src='../sites/default/documents/".$pid."/$from_filename'".($asize[0] > 750 ? " class='bigimage'":'')." style='width:100%;height:100%;' /><br><br>";
                  }
                }
                else {
...
<?php
 if($PDF_OUTPUT)
 {
  ...
  require_once(__DIR__."/../modules/sms_email_reminder/cron_functions_email.php");
